...
Tool guides: [ast-grep for structural search and refactoring](docs/ast-grep.md), [Semgrep security rules](docs/semgrep.md), [project-local Playwright MCP](docs/playwright-mcp.md), [opt-in Context7 MCP](docs/context7-mcp.md).
